...
@Component({
  ...
  imports: [
    ...
    InputGroupAddonModule,ButtonModule, DropdownModule, ToastModule, NzMenuModule,
     ...
     MenuModule, SplitButtonModule, DrawerModule, SpeedDialModule, InplaceModule,NzButtonModule, 
     NzIconModule, NzUploadModule, ToggleSwitchModule, TooltipModule, TagModule, CheckboxModule, 
     TreeTableModule, ProgressSpinnerModule, AccordionModule,
  ],
  animations:[
    trigger('efeitoFade',[
      transition(':enter',[
...
export class ArquivoComponent implements OnInit, OnDestroy {
  ...
  todosFrescoSelecionados: boolean = false;
  todosSoltoSelecionados: boolean = false;
  ...
  // Opções específicas para Colante
  incluirTabelaResistenciaTempoAberto: boolean = false;
  incluirTabelaResistenciaCuraNormal: boolean = false;
  incluirTabelaResistenciaSubmersa: boolean = false;
  incluirTabelaResistenciaEstufa: boolean = false;
  incluirTabelaDeslizamento: boolean = false;
  ...
  // Getter para verificar se o produto é colante
  get isProdutoColante(): boolean {
    const produto = this.amostra_detalhes_selecionada?.amostra_detalhes?.produto_amostra_detalhes?.nome;
    return produto?.toLowerCase().includes('colante') || false;
  }

  // Getter para verificar se o produto é argamassa (mas não colante)
  get isProdutoArgamassa(): boolean {
    const produto = this.amostra_detalhes_selecionada?.amostra_detalhes?.produto_amostra_detalhes?.nome;
    const nomeLower = produto?.toLowerCase() || '';
    // Se tem colante no nome, não é argamassa pura
    if (nomeLower.includes('colante')) {
      return false;
    }
    return nomeLower.includes('argamassa');
  }
...
duplicata(amostra: any): void {
  ...
  // === Armazena os ensaios selecionados para o laudo
  salvarSelecionados() {
    ...
    this.imprimirLaudoPDF(this.amostra_detalhes_selecionada); //passa a os e monta os pdfs
  }
  ...
  ///  LAUDOS PARA DEMAIS MATERIAIS   - (A VER DEPOIS)
  ...
  /// LAUDO PDF ARGAMASSAS e COLANTEAS
...
///  ================================  COMEÂ AQUI A MONTAGEM DO PDF DO LAUDO DE ARG E COLANTES ============================================
  async imprimirLaudoArgPDF(amostra_detalhes_selecionada: any) {

    const logoBase64 = 'data:image/png;base64,';

    const primeira_imgagghgem_arg = 'data:image/png;base64,'

    const primeira_imagem_arg = 'data:image/jpeg;base64,'
    const segunda_imagem_arg = 'data:image/png;base64,'
...
// ====== TABELA FIXA DE ESTADO FRESCO ===================================================
    ...
    if (this.incluirTabelaCompressao && amostra_detalhes_selecionada.compressao) {
      const headCompressao = [
        ...
        [
          ...
          { content: 'Resist. a carga de ruptura a Compressão (MPa)', colSpan: 2 }
        ]
      ];
    ...
    // ====== TABELA SUBSTRATO head2/body2   ==================================================
    const head2 = [
      [
        {content: 'Determinação da resistência potencial de aderência à tração ao substrato - NBR 15258', 
          colSpan: 11 }
      ],
      [
        { content: 'N°', rowSpan: 2 },
    ...
    if(this.incluirTabelaSubstrato && amostra_detalhes_selecionada.substrato){
      ...
      const body2 = [
        ...
        [
          ...
          media,
          { content: 'Observações\n\n\nOs ensaios realizados segundo NBR 15.258 avaliam a qualidade do produto argamassa. A conformidade e atendimento aos requisitos de desempenho do produto quanto a resistência de aderência a tração, deve ser verificada de acordo com a NBR 13.281-1 e de acordo com a tipologia de cada produto ensaiado.', colSpan: 6, rowSpan: 5, styles: { halign: 'left', valign: 'top', fontSize: 7 } }
        ],
        [
        ...
        [
          { content: '', colSpan: 11, styles: { minCellHeight: 30, cellPadding: 0 } }
        ],
        [
          { content: 'Figura adaptada ABNT NBR 15258:2021', colSpan: 11, styles: { halign: 'center', fontSize: 7, fontStyle: 'italic', cellPadding: 1 } }
        ],
      ];
      ...
      autoTable(doc, {
        ...
        didParseCell: function(data: any) {
          ...
          // Garantir que a última linha tenha a borda inferior
        ...
        didDrawCell: function(data: any) {
          ...
          // Desenhar a imagem na célula específica
          if (data.section === 'body' && data.row.index === body2.length - 2 && data.column.index === 0) {
            const doc = data.doc;
            const cellX = data.cell.x + 1;
            const cellY = data.cell.y + 1;
            const cellWidth = data.cell.width - 2;
            const cellHeight = data.cell.height - 2;
            doc.addImage(primeira_imagem_arg, 'PNG', cellX, cellY, cellWidth, 25);
          }
          // Garantir que a última linha da tabela tenha a borda inferior desenhada
          if (data.section === 'body' && data.row.index === body2.length - 1) {
            const doc = data.doc;
    ...
    if(this.incluirTabelaSuperficial && amostra_detalhes_selecionada.superficial){
      ...
      autoTable(doc, {
        ...
        didParseCell: function(data: any) {
          ...
          // Garantir que a última linha tenha a borda inferior
          if (data.section === 'body' && data.row.index === body3.length - 1) {
            data.cell.styles.lineWidth = 0.1;
          }
        },
        didDrawCell: function(data: any) {
          ...
          // Desenhar a imagem na célula específica
          if (data.section === 'body' && data.row.index === body3.length - 2 && data.column.index === 0) {
            const doc = data.doc;
            const cellX = data.cell.x + 1;
            const cellY = data.cell.y + 1;
            const cellWidth = data.cell.width - 2;
            const cellHeight = data.cell.height - 2;
            doc.addImage(segunda_imagem_arg, 'PNG', cellX, cellY, cellWidth, 25);
          }
          // Garantir que a última linha da tabela tenha a borda inferior desenhada
          if (data.section === 'body' && data.row.index === body3.length - 1) {
            const doc = data.doc;
    ...
    const totalPages = doc.internal.pages.length - 1; // Subtrai 1 porque a primeira página é vazia
...
// ======================  Abre modal para montagem do laudo ARGAMASSA E COLANTES ================================ //
  abrirModalLaudo(amostra_detalhes: any) {
    this.amostra_detalhes_selecionada = amostra_detalhes;
    
    // Debug: verificar nome do produto
    console.log('Amostra detalhes completo:', amostra_detalhes);
    console.log('Produto da amostra:', amostra_detalhes?.amostra_detalhes?.produto_amostra_detalhes?.nome);
    console.log('É colante?', this.isProdutoColante);
    console.log('É argamassa?', this.isProdutoArgamassa);
    ...
    // Resetar estados dos checkboxes "selecionar todos"
    this.todosFrescoSelecionados = false;
    this.todosSoltoSelecionados = false;
    ...
    /////// Monta o que vai aparecer no modal de seleção (Argamassa | Colantes)   
    this.modalLaudo = true;
  }

  toggleTodosFresco(event: any) {
    if (event.checked) {
      // Adicionar todos os itens do fresco que ainda não estão selecionados
      const novosItens = this.ensaios_laudo_fresco.filter(
        (ensaio: any) => !this.ensaios_selecionados.find(e => e.id === ensaio.id)
      );
      this.ensaios_selecionados = [...this.ensaios_selecionados, ...novosItens];
    } else {
      // Remover todos os itens do fresco
      this.ensaios_selecionados = this.ensaios_selecionados.filter((sel: any) => 
        !this.ensaios_laudo_fresco.find(e => e.id === sel.id)
      );
    }
    this.cdr.detectChanges();
  }

  toggleTodosSolto(event: any) {
    if (event.checked) {
      // Adicionar todos os itens do solto que ainda não estão selecionados
      const novosItens = this.ensaios_laudo_solto.filter(
        (ensaio: any) => !this.ensaios_selecionados.find(e => e.id === ensaio.id)
      );
      this.ensaios_selecionados = [...this.ensaios_selecionados, ...novosItens];
    } else {
      // Remover todos os itens do solto
      this.ensaios_selecionados = this.ensaios_selecionados.filter((sel: any) => 
        !this.ensaios_laudo_solto.find(e => e.id === sel.id)
      );
    }
    this.cdr.detectChanges();
  }
