...
gerarNumero(materialNome: string, sequencial: number): string {
  ...
  loadAnalises(): void {
    this.analiseService.getAnalises().subscribe(
      (response: any[]) => {
        ...
        console.log('Aquidddd', this.analises);
  ...
  loadOrdens():void{
   ...
   abrirModalLaudo(amostra_detalhes: any) {
    ...
    // if(amostra_detalhes.amostra_detalhes.expressa_detalhes){
    //   amostra_detalhes.amostra_detalhes.expressa_detalhes.ensaio_detalhes.forEach((ensaio_detalhes: any) => {
    ...
    // }else{
      ...
      if(amostra_detalhes.ultimo_calculo){
        amostra_detalhes.ultimo_calculo.ensaios_utilizados.forEach((ensaios_utilizados: any) => {
            this.ensaios_laudo.push({
              id: ensaios_utilizados.id,
              descricao: ensaios_utilizados.descricao
            });
  ...
  imprimirLaudoPDF(amostra_detalhes_selecionada: any){
    console.log('tiutiua', amostra_detalhes_selecionada);
  ...
  async imprimirLaudoArgPDF(amostra_detalhes_selecionada: any) {
    ...
    console.log('timbalaie', amostra_detalhes_selecionada);
