...
export class OrcamentoBaseService {
  private apiUrl = 'http://http://172.50.10.79:8008/orcamento/orcamentosbase/'
  private apiRealizadoUrl = 'http://http://172.50.10.79:8008/realizado/realizado/'
  ...
  aplicarDissidio(porcentagem: number){
    const dissidioUrl = 'http://http://172.50.10.79:8008/orcamento/aplicarDissidio/';
