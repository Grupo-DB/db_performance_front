...
export class EnsaioService {
  private apiUrl = 'https://managerdb.com.br/api/ensaio/tipos_ensaio/';
  private apiUrlEnsaio = 'https://managerdb.com.br/api/ensaio/ensaio/';
  private apiUrlVariaveisEnsaio = 'https://managerdb.com.br/api/ensaio/variavel/';
  private apiUrlCalculoEnsaio = 'https://managerdb.com.br/api/calculosEnsaio/calculoEnsaio/';
  private apiUrlPlano = 'https://managerdb.com.br/api/plano/planoAnalise/';
  constructor(
  ...
  registerEnsaio(descricao: string,  valor: number, tipoEnsaio: any, tempoPrevisto: any, tempoTrabalho: any, unidade:any, variavel: any, funcao: any, norma: any, garantia: any, tecnica: any, estado: string){
    return this.http.post<Ensaio>(this.apiUrlEnsaio, { descricao: descricao, valor: valor, tipo_ensaio: tipoEnsaio, tempo_previsto: tempoPrevisto, tempo_trabalho: tempoTrabalho, unidade: unidade, variavel: variavel, funcao: funcao, norma: norma, garantia: garantia, tecnica: tecnica, estado: estado });
  }
...
//Variáveis de ensaios
  ...
  registerVariavel(nome: string, valor: any, tecnica: any, tipo:any){
    return this.http.post<Variavel>(this.apiUrlVariaveisEnsaio, { nome: nome, valor: valor, tecnica: tecnica, tipo: tipo });
  }
