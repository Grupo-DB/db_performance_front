...
import { AreaResponse } from '../../../types/avaliacoes/area-response';
import { Area } from '../../../pages/avaliacoes/area/area.component';
...
export class AreaService {
  private apiUrl = 'https://managerdb.com.br/api/management/areas/';
