...
//   return this.httpClient.post('https://managerdb.com.br/api/management/update-password-first-login/', { new_password: newPassword });
//   }
...
export class LoginService {
  private apiUrl = 'https://managerdb.com.br/api/management/token/';
  private currentUserSubject: BehaviorSubject<any>;
  public currentUser: Observable<any>;
