...
export class FormularioService {
  private apiUrl = 'https://managerdb.com.br/api/management/formularios/';
  ...
  obterFormulariosDoAvaliado(avaliadoId: number): Observable<any> {
    return this.httpClient.get<any>(`https://managerdb.com.br/api/management/avaliado/${avaliadoId}/formulario/`);
  }
